<div class="ps-contact">
            <div class="container">
                <ul class="ps-breadcrumb">
                    ...
                    <li class="ps-breadcrumb__item active" aria-current="page"><a href="<?= base_url('home/contact_us') ?>">Contact us</a></li>
                </ul>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="ps-contact__info">
                                ...
                                <div class="ps-contact__email"><a href="http://nouthemes.net/cdn-cgi/l/email-protection#83e0ecedf7e2e0f7c3e6fbe2eef3efe6ade0ecee"><span class="__cf_email__" data-cfemail="5e3d31302a3f3d2a1e3b263f332e323b703d3133">[email&#160;protected]</span></a></div>
                                <ul class="ps-social">
                ...
                <section class="ps-section--instagram">
                    ...
                    <div class="ps-section__content">
                        <div class="row m-0">
                            <div class="col-6 col-md-4 col-lg-2"> <a class="ps-image--transition" href="https://www.instagram.com/p/CDf7FC7pwae/"> <img src="<?= FRONTEND_ASSETS_PATH ?>img/instagram/instagram1.jpg" alt><span class="ps-image__overlay"><i class="fa fa-instagram"></i></span></a></div>
                            <div class="col-6 col-md-4 col-lg-2"> <a class="ps-image--transition" href="https://www.instagram.com/p/CDf7D5zJqwo/"> <img src="<?= FRONTEND_ASSETS_PATH ?>img/instagram/instagram2.jpg" alt><span class="ps-image__overlay"><i class="fa fa-instagram"></i></span></a></div>
                            <div class="col-6 col-md-4 col-lg-2"> <a class="ps-image--transition" href="https://www.instagram.com/p/CDf7BnapGmv/"> <img src="<?= FRONTEND_ASSETS_PATH ?>img/instagram/instagram3.jpg" alt><span class="ps-image__overlay"><i class="fa fa-instagram"></i></span></a></div>
                            <div class="col-6 col-md-4 col-lg-2"> <a class="ps-image--transition" href="https://www.instagram.com/p/CDf7Af8JWDj/"> <img src="<?= FRONTEND_ASSETS_PATH ?>img/instagram/instagram4.jpg" alt><span class="ps-image__overlay"><i class="fa fa-instagram"></i></span></a></div>
                            <div class="col-6 col-md-4 col-lg-2"> <a class="ps-image--transition" href="https://www.instagram.com/p/CDf6_QEpWYv/"> <img src="<?= FRONTEND_ASSETS_PATH ?>img/instagram/instagram5.jpg" alt><span class="ps-image__overlay"><i class="fa fa-instagram"></i></span></a></div>
                            <div class="col-6 col-md-4 col-lg-2"> <a class="ps-image--transition" href="https://www.instagram.com/p/CDf69FupFee/"> <img src="<?= FRONTEND_ASSETS_PATH ?>img/instagram/instagram6.jpg" alt><span class="ps-image__overlay"><i class="fa fa-instagram"></i></span></a></div>
                        </div>
                    </div>
                </section>
            </div>
