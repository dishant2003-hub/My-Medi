<div class="ps-about">
            ...
            <div class="ps-banner">
                <div class="ps-banner__block">
                    <div class="ps-banner__content">
                        <div class="ps-logo"><a href="<?= base_url('') ?>"> <img src="<?= FRONTEND_ASSETS_PATH ?>img/logo.png" alt></a></div>
                        <h2 class="ps-banner__title">Your one and only <br>online pharmacy!</h2>
                        <div class="ps-banner__btn-group">
                            <div class="ps-banner__btn"><img src="<?= FRONTEND_ASSETS_PATH ?>img/icon/virus.svg" alt>Up to 5 users simultaneously</div>
                            <div class="ps-banner__btn"><img src="<?= FRONTEND_ASSETS_PATH ?>img/icon/ribbon.svg" alt>Has HEALTH certificate</div>
                        </div><a class="ps-banner__shop bg-yellow" href="#">About</a>
                    </div>
                    <div class="ps-banner__thumnail"><img class="ps-banner__round" src="<?= FRONTEND_ASSETS_PATH ?>img/round5.png" alt><img class="ps-banner__image" src="<?= FRONTEND_ASSETS_PATH ?>img/girl-face-mask.png" alt></div>
                </div>
            </div>
        </section>
                ...
                <div class="row m-0">
                    <div class="col-12 col-md-4 p-0">
                        <div class="ps-block--about">
                            <div class="ps-block__icon"><img src="<?= FRONTEND_ASSETS_PATH ?>img/icon/award-icon-2.png" alt=""></div>
                    ...
                    <div class="col-12 col-md-4 p-0">
                        <div class="ps-block--about">
                            <div class="ps-block__icon"><img src="<?= FRONTEND_ASSETS_PATH ?>img/icon/dentistry-icon-2.png" alt=""></div>
                    ...
                    <div class="col-12 col-md-4 p-0">
                        <div class="ps-block--about">
                            <div class="ps-block__icon"><img src="<?= FRONTEND_ASSETS_PATH ?>img/icon/toothbrush-icon-2.png" alt=""></div>
    ...
    <div class="ps-about__content">
        <section class="ps-about__banner" data-background="<?= FRONTEND_ASSETS_PATH ?>img/Mask-Group.jpg">
            <div class="container">
                <div class="ps-banner">
        ...
        <section class="ps-about__project">
            <div class="container">
                ...
                <section class="ps-section--block-grid">
                    <div class="ps-section__thumbnail"> <a class="ps-section__image" href="#"><img src="<?= FRONTEND_ASSETS_PATH ?>img/about/about-us-1.jpg" alt=""></a></div>
                ...
                <section class="ps-section--block-grid row-reverse">
                    <div class="ps-section__thumbnail"> <a class="ps-section__image" href="#"><img src="<?= FRONTEND_ASSETS_PATH ?>img/about/about-us-2.jpg" alt=""></a></div>
                    <div class="ps-section__content">
                ...
                <section class="ps-section--block-grid">
                    <div class="ps-section__thumbnail"> <a class="ps-section__image" href="#"><img src="<?= FRONTEND_ASSETS_PATH ?>img/about/about-us-3.jpg" alt=""></a></div>
                    <div class="ps-section__content">
                        ...
                        <div class="ps-banner__thumnail">
                            <div style="display:none;" id="video1">
                                <video class="lg-video-object lg-html5" controls="" preload="none">
                                    <source src="<?= FRONTEND_ASSETS_PATH ?>img/video.mp4" type="video/mp4">Your browser does not support HTML5 video.
                                </video>
                            </div><img class="ps-banner__image" src="<?= FRONTEND_ASSETS_PATH ?>img/about/goby-tD3GaS9ysF4-unsplash-1.jpg" alt>
                            <div id="ps-video-gallery">
                                <div class="video" data-html="#video1" data-poster="img/about/goby-tD3GaS9ysF4-unsplash-1.jpg">
                                    <a href="#">
        ...
        <section class="ps-section--reviews" data-background="img/roundbg.png">
            <h3 class="ps-section__title"> <img src="<?= FRONTEND_ASSETS_PATH ?>img/quote-icon.png" alt>Latest reviews</h3>
            <div class="ps-section__content">
                ...
                <div class="owl-carousel" data-owl-auto="false" data-owl-loop="true" data-owl-speed="13000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="3" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="2" data-owl-item-lg="3" data-owl-item-xl="3" data-owl-duration="1000" data-owl-mousedrag="on">
                    <div class="ps-section__item">
                        <div class="ps-blog--latset">
                            <div class="ps-blog__thumbnail"><a href="blog-post1.html"><img src="<?= FRONTEND_ASSETS_PATH ?>img/blog/blog2-496x262.jpg" alt="alt" /></a>
                    ...
                    <div class="ps-section__item">
                        <div class="ps-blog--latset">
                            <div class="ps-blog__thumbnail"><a href="blog-post1.html"><img src="<?= FRONTEND_ASSETS_PATH ?>img/blog/blog11-496x262.jpg" alt="alt" /></a>
                                <div class="ps-blog__badge"><span class="ps-badge__item">MEDIC</span><span class="ps-badge__item">PHARMACY</span><span class="ps-badge__item">SALE</span>
                                </div>
                            </div>
                            <div class="ps-blog__content">
                    ...
                    <div class="ps-section__item">
                        <div class="ps-blog--latset">
                            <div class="ps-blog__thumbnail"><a href="blog-post1.html"><img src="<?= FRONTEND_ASSETS_PATH ?>img/blog/blog13-496x262.jpg" alt="alt" /></a>
                                <div class="ps-blog__badge"><span class="ps-badge__item">MEDIC</span><span class="ps-badge__item">PHARMACY</span><span class="ps-badge__item">SALE</span>
                                </div>
                            </div>
                            <div class="ps-blog__content">
                    ...
                    <div class="ps-section__item">
                        <div class="ps-blog--latset">
                            <div class="ps-blog__thumbnail"><a href="blog-post1.html"><img src="<?= FRONTEND_ASSETS_PATH ?>img/blog/blog12-496x262.jpg" alt="alt" /></a>
                                <div class="ps-blog__badge"><span class="ps-badge__item">MEDIC</span><span class="ps-badge__item">PHARMACY</span><span class="ps-badge__item">SALE</span>
                                </div>
                            </div>
                            <div class="ps-blog__content">
