            ...
            <div class="row row-reverse">
                <div class="col-12 col-md-9">
                    <div class="ps-categogy__wrapper">
                        <div class="ps-categogy__type"> <a href="#"><img src="<?= FRONTEND_ASSETS_PATH ?>img/icon/bars-dark.svg" alt></a><a href="#"><img src="<?= FRONTEND_ASSETS_PATH ?>img/icon/gird2-dark.svg" alt></a><a class="active" href="#"><img src="<?= FRONTEND_ASSETS_PATH ?>img/icon/gird3-dark.svg" alt></a><a href="#"><img src="<?= FRONTEND_ASSETS_PATH ?>img/icon/gird4-dark.svg" alt></a></div>
                                        ...
                                        <div class="ps-product ps-product--standard">
                                            <div class="ps-product__thumbnail">
                                                ...
                                                <div class="ps-product__actions">
                                                    ...
                                                    ?>
                                                        <div class="ps-product__item" data-toggle="tooltip" data-placement="left" title="Wishlist"><a href="<?= base_url('wishlist_session/' . $data['id']) ?>"><i class="fa fa-heart-o"></i></a></div>
