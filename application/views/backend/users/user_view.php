                ...
                <div class="info-container">
                    <ul class="list-unstyled">
                        <li class="mb-3">
                            ...
                            <span><?= (isset($rowData['fname'])) ? $rowData['fname'] : "" ?> <?= (isset($rowData['lname'])) ? $rowData['lname'] : "" ?></span>
                        </li>
                        <li class="mb-3">
                        ...
                        <li class="mb-3">
                            ...
                            <span><?= (isset($rowData['mobile'])) ? $rowData['mobile'] : "" ?></span>
                        </li>
                        <li class="mb-3">
                            <span class="fw-bold me-2">Zipcode:</span>
                            <span><?= (isset($arrow['zipcode'])) ? $arrow['zipcode'] : "" ?></span>
                        </li>
                        <li class="mb-3">
                            <span class="fw-bold me-2">City:</span>
                            <span><?= (isset($arrow['city'])) ? $arrow['city'] : "" ?></span>
                        </li>
                        <li class="mb-3">
                            <span class="fw-bold me-2">Address:</span>
                            <span><?= (isset($arrow['address'])) ? $arrow['address'] : "" ?></span>
                        </li>
                    </ul>
