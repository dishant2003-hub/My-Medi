<div class="row ">
    <div class="col-lg-12">
        <div class="card ">
            ...
            <div class="card-body">
                <span id="msg"></span>
                <form id="userForm" action="<?= base_url('backend/users/add'); ?>" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group row mb-2">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" name="address" id="address" placeholder="Enter Address"><?= isset($arrow['address']) ? $arrow['address'] : ''; ?></textarea>
                                </div>
                            </div>
                            <div class="row">
                            <div class="col-lg-6">
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="city" id="city" placeholder="Enter City" value="<?= isset($arrow['city']) ? $arrow['city'] : ''; ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="pincode" id="pincode" placeholder="Enter Zipcode" value="<?= isset($arrow['zipcode']) ? $arrow['zipcode'] : ''; ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="state" id="alocation" placeholder="Enter" value="<?= isset($arrow['state']) ? $arrow['state'] : ''; ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
