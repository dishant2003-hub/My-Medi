    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row invoice-preview">
                    ...
                    <div class="card invoice-preview-card">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column p-sm-3 p-0">
                                ...
                                <div>
                                    <h4>Invoice #<?= $result['id'] ?></h4>
                                    <div class="date">
                                        <span class="me-1">Date :</span>
                                        <span class="fw-semibold"><?= $result['created_at'] ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table border-top m-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        ?>
                                            <td><?= $obj['name'] ?></td>
                                            <td><img src="<?php echo base_url(UPLOAD . $obj['image']); ?>" width="70%"></td>
                                            <td>$<?= $obj['price'] ?></td>
                                            <td><?= $obj['quantity'] ?></td>
                                            <td>$<?= $obj['total'] ?></td>
                                    </tr>
                ...
                <!-- /Invoice -->
                <!-- Invoice Actions -->
                <div class="col-xl-6 col-md-6 col-6 mt-3 invoice-actions">
                    <div class="card">
                        <div class="card-body">
                            <button class="btn btn-primary d-grid w-100 text-center" data-bs-toggle="offcanvas" data-bs-target="#sendInvoiceOffcanvas">
                                <span> <a class="button_back" href="<?= base_url('backend/orderdetails/cart/' . $result['id']); ?>"> Print </a> </span>
                            </button>
                        </div>
                    </div>
                </div>
